...
// zorientowany wzdłuż krawędzi CZOŁOWEJ (frontEdge) — pierwszej krawędzi napotykanej w
// kierunku wchodzenia, granica z poprzednim, niższym stopniem (backEdge to granica z
// NASTĘPNYM stopniem — krawędź wyjściowa, nie czołowa). Z konwencji produkcyjnej ta krawędź
// jest zawsze DŁUŻSZYM bokiem formatki. "długość" = rozpiętość rzutów wszystkich wierzchołków
// konturu na kierunek frontEdge, "głębokość" = rozpiętość rzutów prostopadle do niego —
